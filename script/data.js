...
$.extend( true, DataTable.ext.classes, {
    ...
    // Edit manually the search:input and length:select
	search: {
        //  dark:bg-gray-800 placeholder-gray-500 dark:border-gray-600 border-gray-200 
		input: "border border-neutral-800 px-3 py-2 ml-2  rounded-lg  focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-rose-100  dark:focus:border-blue-500 dark:placeholder-gray-400"
	},
	length: {
		select: "border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-rose-100 dark:border-gray-600 dark:focus:border-blue-500"
	},
	processing: {
	...
	thead: {
        //  Editing the table head manually -->> color and text color etc... 
		// row: 'border-b border-gray-100 dark:border-gray-700/50',
		row: 'border-b border-gray-800 dark:border-gray-700/90',
		cell: 'px-4 py-3 bg-gray-100/75 font-semibold text-left dark:text-white dark:bg-stone-900/70'
		// cell: 'px-3 py-4 text-gray-900 bg-gray-100/75 font-semibold text-left dark:text-gray-900 dark:bg-gray-700/25'
	},
	tbody: {
		row: 'even:bg-gray-50 dark:even:bg-gray-900/30',
		cell: 'p-2.5'
	},
	tfoot: {
